...
<b>Warning</b>:  Undefined variable $dir in <b>/Users/mak22online/Local Sites/synnestrav2/app/public/wp-content/plugins/timeline-widget-addon-for-elementor/widgets/editor-layouts/horizontal-template.php</b> on line <b>20</b><br />
    ...
    <div class="twae-slider-wrapper swiper-wrapper {{{slideHeight}}}">
            ...
            <div class="twae-story-line"></div>
                    ...
                    <div class="twae-content">
                        ...
                        <div class="twae-media  {{{timeline_image.size}}}"><img src="https://SynnestraEnterprise.github.io/SynnestraEnterprise//wp-content/plugins/timeline-widget-addon-for-elementor/widgets/editor-layouts/{{{ image_url }}}"></div>
